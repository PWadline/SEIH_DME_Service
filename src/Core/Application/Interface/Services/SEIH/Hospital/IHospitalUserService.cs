...
{
    Task<ServiceResult<string>> HospitalCreateUserServiceAsync(ClaimsPrincipal claim, CreateUserModel dataModel);
    ...
    Task<ServiceResult<bool>> HospitalUpdateUserProfileAsync(ClaimsPrincipal claim, UpdateUserProfileModel model);
}
