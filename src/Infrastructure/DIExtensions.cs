...
using Infrastructure.Services.SEIH.Record;
...
namespace Infrastructure
{
    public static class DIExtensions
    {
        public static IServiceCollection AddServices(this IServiceCollection services, IConfiguration config)
        {
            ...
            services.AddScoped<IInstitutionKeyRepository, InstitutionKeyRepository>();
            services.AddScoped<IRecordRepository, RecordRepository>();
            services.AddScoped<IRecordService, RecordService>();
            services.AddScoped<IRecordRepository, RecordRepository>();
            services.AddScoped<IRecordFieldValueRepository, RecordFieldValueRepository>();
            ...
            services.AddScoped<IHospitalBranchService, HospitalBranchService>();

            services.AddScoped<ISeihFileRepository, SeihFileRepository>();
            services.AddScoped<ISeihFileService, SeihFileService>();
            ...
            services.AddScoped<ISeihCryptoService, SeihCryptoService>();
            services.AddScoped<IInboundTransferService, InboundTransferService>();
            services.AddScoped<ITransferInstitutionKeyRepository, TransferInstitutionKeyRepository>();
            services.AddScoped<ISignatureEnvelopeBuilder, SeihSignatureEnvelopeBuilder>();
